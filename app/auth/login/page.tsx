...
const LoginForm = () => {
    return(
        <div className="pt-10 relative w-[400px] h-[470px] bg-[transparent] backdrop-blur-sm border-2 border-[rgba(var(--secondary-color),0.5)] rounded-[20px] flex justify-center items-center">
            <form action="">
                ...
                <div className="relative w-[330px] my-[30px] border-b-2 border-[#fff]">
                    ...
                    <input type="email" id="email" className="pr-[35px] pl-[5px] peer w-full h-[50px] bg-[transparent] border-none outline-none text-base text-[rgba(var(--secondary-color))]" required />
                ...
                <div className="relative w-[330px] my-[30px] border-b-2 border-[#fff]">
                    <span className="absolute right-[8px] top-[12px] leading-[57px] text-lg">
                        <Image src="/password-logo.svg" alt="mail-logo" width={20} height={20}/>
                    </span>
                    <input type="password" id="password" className="pr-[35px] pl-[5px] peer w-full h-[50px] bg-[transparent] border-none outline-none text-base text-[rgba(var(--secondary-color))]" required />
                ...
                <div className="mt-[-15px] mb-[15px] text-[0.9rem] text-[rgba(var(--secondary-color))] flex flex-col justify-between gap-3">
                    <div className="flex">
                        <label htmlFor=""><input type="checkbox" className="mr-[3px]"/>
                            Se rappeler de moi
                        </label>
                    </div>
                ...
                <div className="flex flex-col justify-center items-center pt-5">
                    ...
                    <div className="text-[rgba(var(--secondary-color))] text-[0.9rem] text-center mt-[25px] mb-[10px]">
                        <p> Première connection ? <a href="/auth/register" className="hover:underline font-bold"> S'inscrire</a> </p>
                    </div>
                </div>
            </form>
        </div>
