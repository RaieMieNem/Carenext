...
const RegisterForm = () => {
    return(
        <div className="relative w-[400px] h-[430px] bg-[transparent] backdrop-blur-sm border-2 border-[rgba(var(--secondary-color),0.5)] rounded-[20px] flex justify-center items-center">
            <form action="">
